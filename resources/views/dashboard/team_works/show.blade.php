...
{{--                     <textarea name="name" cols="30" rows="10"  class="form-control">{{isset($team_work)?$team_work->name:""}}</textarea>--}}
                     <input type="text" name="name" class="form-control" value="{{isset($team_work)?$team_work->name:""}}" disabled>
                 </div>
                 <div class="form-group">
                     <label>{{__('site.email')}} :</label>
                     <input type="text" name="email" class="form-control" value="{{isset($team_work)?$team_work->email:""}}" disabled>
                 </div>
                 <div class="form-group">
                     <label>{{__('site.image')}} :</label><br>
                    @isset($team_work)
                         <td><img class="imageSize" src="{{asset('storage/'.$team_work->image)}}" alt=""></td>
                         <input type="file" name="image" class="form-control" value="{{isset($team_work)?$team_work->image:""}}" disabled>
                     @else
                         <input type="file" name="image" class="form-control" value="{{isset($team_work)?$team_work->image:""}}" disabled>
                     @endisset
                  </div>
                 <div class="form-group">
                     ...
                     <input type="text" name="address" class="form-control" value="{{isset($team_work)?$team_work->address:""}}" disabled>
                 </div>
                  <div class="form-group">
...
{{--             </form>--}}
                <div class="form-group">
                    <a class="btn btn-primary form-group" href="{{route('dashboard.team_works.index')}}">back</a>
                </div>
            </div>{{-- end-of-col-12 --}}
        </div>{{--end-of-row--}}
